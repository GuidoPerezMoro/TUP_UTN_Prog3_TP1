...
public class Ejer01Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("Estoy funcionando --> Ejercicio 1 --> Puerto 8080 :)");
	}
...
//        PersonaRepository personaRepository = context.getBean(PersonaRepository.class); //Preguntar el porqué de esta línea
